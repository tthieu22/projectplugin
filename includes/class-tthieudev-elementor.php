...
if (!class_exists('Tthieudev_Elementor')) {
    class Tthieudev_Elementor {
        ...
        public function include_files() {
            require_once TTHIEUDEV_PLUGIN_PATH . 'includes/class-tthieudev-ajax.php';
            require_once TTHIEUDEV_PLUGIN_PATH . 'includes/class-tthieudev-widget-manager.php';
        }
    ...
    if (!function_exists('tthieudev_elementor_instance')) {
        function tthieudev_elementor_instance() {
            return Tthieudev_Elementor::instance();
        }
    }

    tthieudev_elementor_instance();
}
